class MCPFeedbackSidePanel {
    constructor() {
        ...
        this.automationEngine = new AutomationEngine(this.sendWebSocketMessage.bind(this));
    ...
    handleMCPMessage(message) {
        ...
        if (message.action === 'automation') {
            this.automationEngine.handleCommand(message);
        }
    }
